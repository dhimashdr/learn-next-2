...
export default function Cards({buku} : Books){
    return <div className="bg-linear-to-b from-red-950/40 to-cyan-950/40 flex rounded-lg md:rounded-xl drop-shadow-lg drop-shadow-background h-42 md:h-54 items-center-safe">
        ...
        <div className={`${inter.className} mx-auto p-4 w-1/2 flex-2/3`}>
            <p className="font-black text-sm md:text-lg">{buku.title}</p>
