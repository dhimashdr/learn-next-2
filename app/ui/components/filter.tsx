...
export default function Filter(){
    ...
    <div className="text-xs md:text-sm">
        <button onClick={showFilter} className="px-4 w-full bg-slate-700 text-left hover:bg-slate-800 rounded-full delay-50 transition-all py-1 text-slate-400 border md:border-2 border-slate-300">
            <div className="flex">
